  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-cream/90 backdrop-blur-md border-b border-warm-beige">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <img src="https://cdn.poehali.dev/projects/fbdd8c30-03fa-4929-b997-7be7b56e3ad3/bucket/1bf126ce-fd0d-4805-b270-8d3828087b37.png" alt="Body Slim" className="h-10 w-auto" />
