...
const services = [
  ...
  },
  {
    icon: "Waves",
    title: "Кавитация",
    desc: "Ультразвуковое разрушение жировых клеток без хирургического вмешательства. Эффективное уменьшение объёмов в проблемных зонах.",
    duration: "30 мин",
    effect: "Жиросжигание",
  },
  {
    ...
    desc: "Интенсивная вибрационная стимуляция мышц и тканей для улучшения лимфотока, снятия отёков и повышения тонуса кожи.",
    duration: "30 мин",
    effect: "Тонус и лимфодренаж",
  },
  {
    icon: "Circle",
    title: "Эндосфера",
    desc: "Компрессионно-сферическая технология для глубокого лимфодренажа, устранения целлюлита и моделирования тела.",
    duration: "30 мин",
    effect: "Лимфодренаж",
  },
  {
    icon: "Activity",
    title: "EMS скульпт",
    desc: "Электромиостимуляция для одновременного сжигания жира и роста мышц. Эффект тренировки без нагрузки на суставы.",
    duration: "30 мин",
    effect: "Рельеф тела",
  },
  {
    ...
    desc: "Радиочастотное воздействие для глубокого прогрева тканей, стимуляции коллагена и выраженного лифтинг-эффекта.",
    duration: "30 мин",
    effect: "Подтяжка кожи",
  },
  {
    icon: "RotateCcw",
    title: "Роликовый массажёр",
    desc: "Механический роликовый массаж для разминания глубоких слоёв ткани, улучшения кровообращения и борьбы с целлюлитом.",
    duration: "30 мин",
    effect: "Антицеллюлит",
  },
  {
    icon: "Leaf",
    title: "Индиба терапия",
    desc: "Высокочастотная радиотерапия для глубокого прогрева, ускорения метаболизма и восстановления тканей изнутри.",
    duration: "30 мин",
    effect: "Глубокий прогрев",
  },
  {
    icon: "Flashlight",
    title: "Лазерный липолиз",
    desc: "Низкоинтенсивное лазерное воздействие на жировые клетки для безболезненного уменьшения объёмов без реабилитации.",
    duration: "30 мин",
    effect: "Коррекция объёмов",
  },
  {
    icon: "Wind",
    title: "Прессотерапия с прогревом",
    desc: "Пневматический лимфодренажный массаж с тепловым эффектом. Выводит токсины, снимает отёки и улучшает самочувствие.",
    duration: "30 мин",
    effect: "Детокс и отёки",
  },
  {
    icon: "Layers",
    title: "Субдермальный массаж",
    desc: "Глубокое механическое воздействие на подкожные слои ткани для разрушения фиброзных перегородок, улучшения циркуляции и выраженного антицеллюлитного эффекта.",
    duration: "30 мин",
    effect: "Глубокое воздействие",
  },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-5xl md:text-7xl text-white leading-tight mb-6">
              Тело,<br />
              <em className="not-italic" style={{ color: "hsl(270 60% 80%)" }}>которое вы</em><br />
              заслуживаете
            </h1>
